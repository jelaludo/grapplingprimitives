...
const PressureGameCardPreview: React.FC = () => {
  // Create a mini heatmap visualization
  const gridSize = 8;
  ...
  for (let y = 0; y < gridSize; y++) {
    for (let x = 0; x < gridSize; x++) {
      ...
      // Create a heat-like pattern
      const noise = Math.sin(x * 0.8) * Math.cos(y * 0.8) * 0.3 + 0.7;
...
export default PressureGameCardPreview;
