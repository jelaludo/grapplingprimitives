...
function convertBJJConceptToConceptPoint(concept) {
    ...
    var x = (concept.axis_self_opponent - 0.5) * 2; // 0->-1, 0.5->0, 1->1
    var y = (concept.axis_mental_physical - 0.5) * 2; // 0->-1, 0.5->0, 1->1
    return {
        id: concept.id,
...
function ConceptMatrix(param) {
    ...
    var screenDeltaToViewBox = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ConceptMatrix.useCallback[screenDeltaToViewBox]": function(deltaX, deltaY) {
            ...
            var viewBoxDeltaX = deltaX / (dimensions.width / 4);
            var viewBoxDeltaY = deltaY / (dimensions.height / 4);
            return {
                x: viewBoxDeltaX,
                y: viewBoxDeltaY
            };
    ...
    var handleDoubleClick = function(e) {
        ...
        var dataPoint = screenToDataSpace(screenX, screenY);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                        transform: "\n            scale(".concat(panZoom.state.zoom, ")\n            translate(\n              ").concat(panZoom.state.translateX / panZoom.state.zoom, ", \n              ").concat(panZoom.state.translateY / panZoom.state.zoom, "\n            )\n          "),
                        children: filteredConcepts.map(function(concept, index) {
                            ...
                            if (index < 5) {
                                console.log("Dot ".concat(index, ': "').concat(concept.label, '" - normalized: (').concat(concept.x.toFixed(2), ", ").concat(concept.y.toFixed(2), ") -> SVG: (").concat(svgX.toFixed(2), ", ").concat(svgY.toFixed(2), ") color: ").concat(color));
                            }
...
_s(ConceptMatrix, "dBfE7Cv9GveEB41cayBQjVhC3Zk=", false, function() {
    return [
...
//# sourceMappingURL=_dd70365b._.js.map